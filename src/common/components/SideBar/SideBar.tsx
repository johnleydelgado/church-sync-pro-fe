...
const SideBar: FC<SideBarProps> = ({ isTrigger, setIsTrigger }) => {
  ...
  return (
    <aside
      className={`h-screen relative left-0 top-0 z-40 w-0 transform transition-width ease-in duration-300 ${
    ...
    >
      <div className="h-full bg-primary shadow-md sm:flex flex-col gap-4">
        ...
        {isTrigger ? (
          <div className="mt-auto transition transform duration-100 hover:bg-green-300 hover:text-primary text-white">
