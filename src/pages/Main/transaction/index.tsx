...
const Dashboard: FC<DashboardProps> = () => {
  ...
  const triggerSyncBatch = async ({
    ...
    try {
      ...
      if (result.success) {
        // Say what actually happened - this runs the daily journal-entry engine, which
        // posts only Stripe-processed giving, so a cash or cheque batch produces nothing.
